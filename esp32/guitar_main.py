...
while True:
    ...
    if music_on == 6:
        ...
        if curr_time == '':
            conn.send('Location: https://www.youtube.com/watch?v=ZV5qaR1VbFg' + curr_time)
        else:
            conn.send('Location: https://www.youtube.com/watch?v=ZV5qaR1VbFg&feature=youtu.be&t=' + curr_time)
