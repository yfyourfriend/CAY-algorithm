...
while True:
    ...
    if music_on == 6:
        ...
        if curr_time == '':
            conn.send('Location: https://www.youtube.com/watch?v=PCicM6i59_I' + curr_time)
        else:
            conn.send('Location: https://www.youtube.com/watch?v=PCicM6i59_I&feature=youtu.be&t=' + curr_time)
