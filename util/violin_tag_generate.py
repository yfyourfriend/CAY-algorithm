...
class LetterMaker(object):
    ...
    def createDocument(self):
        ...
        # tag_num = 1
        tag_num = start_tag + bar_per_bulk_line * num_music_lines
...
if __name__ == "__main__":
    ...
    input_file = PdfFileReader(open("../violinfuguebwv1001p3.pdf", "rb"))
    ...
    output_file.write(open("violin-output.pdf","wb"))
